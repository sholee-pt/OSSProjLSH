...
* 열량 기반 경로 최적화
   * 시간이나 거리가 아닌 열량 소비를 최소화하여, 휠체어 사용자가 가장 효율적으로 이동할 수 있는 경로 제공
* 이동 편의성 증대
...
1. 황석진/장윤희/강정선/김규석, 휠체어 사용자 에너지 소모도 측정 방법 및 이를 실행하는 장치, https://patents.google.com/patent/KR102438204B1/ko, 2020  
2. 공공데이터포털, 서울시 경사도, https://data.seoul.go.kr/dataList/OA-22241/F/1/datasetView.do, 2023.12.26  
