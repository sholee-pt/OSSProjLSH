...
* 기존의 '동국대학교 편한 길 찾기'에서는 없었던 전동 휠체어 사용자을 위한 계단과 높은 경사도를 사용하지 않는 경로를 추가로 소개하는 프로그램을 개발하려고 한다.  
...
* 전동 휠체어를 이용했을 때 사용되는 전력량은 다음과 같다.  
...
* 걷기 열량 계산 vs. 전동 휠체어 전력 계산  
  : 일반인의 걷기 열량은 1.67 x (속도) + 0.15 x (경사도) x (속도) + 3.5 (ml/kg)을 기반으로 구할 수 있다. 하지만 전동 휠체어 이용자들은 열량 계산법이 아닌 전력 소비량을 구해야 하므로 (추가 예정)으로 재설정하였다. 
...
구분 | 성명 | 팀내 역할 
:----:|:-----:|-------
팀장 | 권일준 | ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ  
팀원 | 김명하 |         
팀원 | 이승호 |         
