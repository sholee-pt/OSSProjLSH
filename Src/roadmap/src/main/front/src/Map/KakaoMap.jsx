...
//                 <select className="box-style" onChange={(e) => {
//                     SetStart(e.target.value);
//                     console.log("Start selected:", e.target.value); // 로그 추가
//                 }}>
//                     <option selected disabled>출발지 선택</option>
//                     {loc.map((building) => <option key={building.code} value={building.code}>{building.id}</option>)}
//                 </select>
...
//                     const selectedValue = e.target.value;
//                     SetFinish(selectedValue);
//                     console.log("Finish selected:", selectedValue); // 로그 추가
//                 }}>
//                     <option selected disabled>도착지 선택</option>
//                     {loc.map((building) => (
//                         <option
...
//                 <button className="button-style" onClick={
//                     () => {
//                         console.log("Start:", start); // 로그 추가
//                         console.log("Finish:", finish); // 로그 추가
//                         if (start && finish) {
//                             axios.get('/map', {
//                                 params: {
//                                     start: start,
